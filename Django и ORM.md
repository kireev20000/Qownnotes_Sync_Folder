...
7. Миграции баз данных - это процесс автоматического обновления структуры базы данных при изменении моделей данных.
...
10. Типы ответов HTTP: 200 OK, 201 Created, 204 No Content, 400 Bad Request, 401 Unauthorized, 403 Forbidden, 
